  ...
  const handleChange = (e) => {
    ...
    if (name.includes('.')) {
      ...
      setFormData({
        ...formData,
        [parent]: {
          ...(formData[parent] || {}), // Use empty object if parent is undefined
          [child]: value
        }
      });
    } else if (type === 'checkbox') {
      if (name === 'featured') {
        // For the featured checkbox
        setFormData({
          ...formData,
          [name]: checked
        });
    ...
    try {
      if (isEditing) {
        ...
        const updatedProperty = await updateListing(property._id, {
          ...formData,
          images: existingImages // Pass existing images that weren't removed
        });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-8 px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
          ...
          <div className="md:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-4">
              ...
              <div>
                <label htmlFor="propertySize" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Size (sq ft)*
                </label>
                <input
                  id="propertySize"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="garage" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                  Garage Spaces
                </label>
                <input
                  id="garage"
          ...
          <div className="md:col-span-2">
            ...
            {/* Custom Amenities */}
            <div className="mt-3">
              <label htmlFor="customAmenities" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              ...
              <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-700 border-dashed rounded-md">
                <div className="space-y-1 text-center">
                  ...
                  <div className="flex text-sm text-gray-600 dark:text-gray-400">
                    <label htmlFor="images" className="relative cursor-pointer bg-white dark:bg-gray-800 rounded-md font-medium text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 focus-within:outline-none">
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-700 pt-8">
          <div className="flex justify-end">
            <button
              type="button"
              onClick={() => router.back()}
              className="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 mr-3"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={isLoading}
              className="inline-flex justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800 disabled:bg-blue-400 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
