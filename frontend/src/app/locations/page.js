...
import { MapPin, Search, ChevronRight, Home } from "lucide-react";
import { ListingsContext } from "@/context/ListingsContext";
import { MotionDiv } from "@/components/MotionWrapper";

// Create a skeleton loader for the locations page
const LocationsSkeletonLoader = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Featured locations grid skeleton */}
      <div className="mb-10">
    ...
    >
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">{propertyCount} listings</p>
        </div>
      </div>
...
export default function LocationsPage() {
  ...
  useEffect(() => {
    const fetchLocationsData = async () => {
      try {
        ...
        // Process the listings to get locations data
        ...
        // Simulate a minimum loading time to show the skeleton
        setTimeout(() => {
          setIsLoading(false);
        }, 1000);
      }
  ...
  // Process listings to extract location information
    ...
    listings.forEach(listing => {
      if (listing.address) {
        ...
        if (city) {
          ...
          cities[city].count++;
          // Update image if none was set previously
          if (!cities[city].image && listing.images && listing.images.length > 0) {
  ...
  // City images for demo (in production, these would come from property images)
  const cityImages = useMemo(() => ({
    "Mumbai": "https://images.unsplash.com/photo-1567157577867-05ccb1388e66?q=80&w=2070&auto=format&fit=crop",
    "Delhi": "https://images.unsplash.com/photo-1587474260584-136574528ed5?q=80&w=2070&auto=format&fit=crop",
    "Bangalore": "https://images.unsplash.com/photo-1596176530529-78163a4f7af2?q=80&w=2089&auto=format&fit=crop",
    "Hyderabad": "https://images.unsplash.com/photo-1563448927272-976d73d27a5f?q=80&w=2070&auto=format&fit=crop",
    "Chennai": "https://images.unsplash.com/photo-1582510003544-4d00b7f74220?q=80&w=2070&auto=format&fit=crop",
    "Kolkata": "https://images.unsplash.com/photo-1536421469767-80559bb6f5e1?q=80&w=2070&auto=format&fit=crop",
  ...
  // Generate fallback locations in case no API data is available
  const fallbackLocations = useMemo(() => {
    return {
      cities: [
        { name: "Mumbai", count: 24, state: "Maharashtra", image: cityImages["Mumbai"] },
        { name: "Delhi", count: 18, state: "Delhi", image: cityImages["Delhi"] },
        { name: "Bangalore", count: 15, state: "Karnataka", image: cityImages["Bangalore"] },
        { name: "Hyderabad", count: 12, state: "Telangana", image: cityImages["Hyderabad"] },
        { name: "Chennai", count: 10, state: "Tamil Nadu", image: cityImages["Chennai"] },
        { name: "Kolkata", count: 9, state: "West Bengal", image: cityImages["Kolkata"] },
        { name: "Pune", count: 8, state: "Maharashtra", image: cityImages["Pune"] },
        { name: "Jaipur", count: 7, state: "Rajasthan", image: cityImages["Jaipur"] },
      ],
      states: [
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-10 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
          Browse our extensive collection of properties across different cities and states in India.
          ...
          {displayLocations.cities.slice(0, 8).map((city, index) => (
            ...
            >
              <LocationCard
                ...
                imageUrl={city.image || cityImages[city.name] || "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?q=80&w=2070&auto=format&fit=crop"}
                index={index}
              />
            </Link>
          ))}
